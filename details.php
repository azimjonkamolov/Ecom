                           ...
                           <form action="details.php?add_cart= <?php echo $product_id; ?> " class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   ...
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       ...
                                       <select name="product_size" class="form-control" required oninput="setCustomerValidity('')" oninvalid="setCustomerValidity('Must pick 1 size for the product')"><!-- form-control Begin -->
                                          
                                           <option disabled="disabled" selected="selected">Select a Size</option>
                                           <option>Small</option>
