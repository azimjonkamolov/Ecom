        ...
        <div class="row"><!-- row Begin -->
            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <p><!-- p Start -->
                    ...
                    <strong>Xumcha trade.</strong>
                    <br/>Shakhrisabz
                    <br/>Kashkadaryo
                    <br/>010-1122-3344
                    <br/>azimjon.6561@gmail.com
                    <br/><strong>Azizbek Kamolov</strong>
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; 2018 Ecom Trade All Rights Reserve</p>
            
                </div><!-- col-md-6 Finish -->
                <div class="col-md-6"><!-- col-md-6 Begin -->
            
            <p class="pull-right">Theme by: <a href="https://www.azimkamol.tk/">Blue Phoenix</a></p>
